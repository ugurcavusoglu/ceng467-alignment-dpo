...
Under this metric, DPO (0.8262) outperforms both zero-shot (0.8294 is higher,
but zero-shot benefits from the base model's prior) and SFT (0.8171), confirming
that DPO produces responses that are more semantically aligned with human preferences.
